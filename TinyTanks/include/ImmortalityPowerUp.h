#ifndef _IMMORTALITYPOWERUP_H_
#define _IMMORTALITYPOWERUP_H_

#include "PowerUp.h"

class ImmortalityPowerUp : public PowerUp
{
public:
	ImmortalityPowerUp(const char* a_fileName, int a_width, int a_height, Vector2 a_position, float a_angle);
